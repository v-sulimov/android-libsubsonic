...
internal object GetArtistsParser {
    ...
    /**
     * Parses an artist index JSON object into an [ArtistIndex].
     *
     * @param json The JSON object representing an alphabetical index group containing artists.
     * @return The parsed [ArtistIndex], or null if the index has no name.
     */
