 ...
 * @property apiVersion The Subsonic REST API version supported by the server (e.g., "1.16.1").
 * @property serverType The implementation type of the server (e.g., "navidrome", "subsonic").
 ...
 */
data class SubsonicPingResponse(
