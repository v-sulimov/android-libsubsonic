...
internal class SubsonicUrlBuilder(private val baseUrl: String, private val clientName: String) {
    ...
    /**
     * The current authenticator instance used to generate signed request parameters.
     * Marked [Volatile] to guarantee cross-thread visibility when [setCredentials] is called
     * from one thread while [buildUrl] is executing on another (e.g. a coroutine on [kotlinx.coroutines.Dispatchers.IO]).
     */
    @Volatile
