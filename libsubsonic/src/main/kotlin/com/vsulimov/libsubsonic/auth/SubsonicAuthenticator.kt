...
/**
 * A utility class for Subsonic API authentication using the "Token and Salt" approach.
 *
 * This class implements the secure authentication approach defined in the Subsonic REST API
 * documentation, where the token (t) is calculated as the MD5 hash of the concatenation
 * of the password and a random salt (s).
 *
 * Using this approach ensures that the clear-text password is never transmitted over the
 * network, providing a layer of security even over non-HTTPS connections.
 *
