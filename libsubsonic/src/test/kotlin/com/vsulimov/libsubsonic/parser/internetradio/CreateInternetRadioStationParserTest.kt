...
class CreateInternetRadioStationParserTest {
    ...
    fun `parse extracts status and version from successful response`() {
        ...
        val response = CreateInternetRadioStationParser.parse(JSONObject(jsonString))
    ...
    fun `parse captures server metadata fields`() {
        val response = CreateInternetRadioStationParser.parse(
